...
|-------------------------------------------------------------------------------------------|---------|----------|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <a name="input_use_default_queries"></a>[use_default_queries](#input_use_default_queries) | boolean |  false   | `false` | Enable "use_default_queries" use to default <br>queries if you notice too <br>many false positives from security-extended <br>queries. Try using whitelist before <br>enabling default queries to have <br>less false positives.  |
