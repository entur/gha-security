...
|     <a name="input_custom_runner"></a>[custom_runner](#input_custom_runner)      | string  |  false   |        `"ubuntu-24.04"`         |               Custom runner for CodeQL jobs <br>that require a little extra <br>performance/memory. List of runners is <br>available in Confluence.                |
