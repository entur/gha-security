...
|     <a name="input_custom_runner"></a>[custom_runner](#input_custom_runner)      | string  |  false   |        `"ubuntu-24.04"`         | Custom runner for CodeQL jobs <br>that require a little extra <br>performance/memory. Default is "ubuntu-24.04". List <br>of runners is available in <br>Confluence.  |
|        <a name="input_gradle_opts"></a>[gradle_opts](#input_gradle_opts)         | string  |  false   | `"-Dorg.gradle.jvmargs=-Xmx4g"` |                                                         Gradle options to pass on <br>to the CodeQL scanner                                                           |
